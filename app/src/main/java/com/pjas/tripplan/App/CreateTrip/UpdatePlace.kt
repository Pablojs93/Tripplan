...
class UpdatePlace  : AppCompatActivity() {
    ...
    fun init()
    {
        val buttonName: String = getString(R.string.bEditPlace)
        ...
        {
            etName.setText(GlobalVariables.actualPlace.place)
            etdBegining.setText(GlobalVariables.actualPlace.begining)
            etdEnd.setText(GlobalVariables.actualPlace.end)
        }
    }
    ...
    fun Add()
    {
        ...
        if(!TextUtils.isEmpty(name) && !TextUtils.isEmpty(begining) && !TextUtils.isEmpty(end))
        {
            ...
            GlobalVariables.placeList.set(GlobalVariables.placePosition, place)
